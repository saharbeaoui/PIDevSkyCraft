 ...
 * @author ahmedshil
 */
public class AjoutVolgeneriqueController implements Initializable {
   ...
   @FXML
    ...
    Volgenerique vol = new Volgenerique(depart,arrive,ldepart,larrive,mtn);
    System.out.println(vol.toString());
    vs.ajouterVolGenerique(vol, dsgn);
