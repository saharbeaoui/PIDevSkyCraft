 ...
 * @author ahmedshil
 */
public class VolGeneriqueController implements Initializable {
...
Parent affichage = FXMLLoader
        .load(getClass().getResource("../View/AjoutVolGenerique.fxml"));
    ...
    void GoAjoutReservation(ActionEvent event) throws IOException {
        Parent affichage = FXMLLoader
        .load(getClass().getResource("../View/AjoutReservationGenerique.fxml"));
        Scene affichageConsultationScene = new Scene(affichage);
        Stage window=(Stage)((Node)event.getSource()).getScene().getWindow();
        window.setScene(affichageConsultationScene);
        window.show();
